...
impl Provider {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ProviderArgs, options: pulumi::ResourceOptions) -> Provider {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "pulumi:providers:simple-invoke".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
...
impl StringResource {
    pub fn new(ctx: &pulumi::Context, name: &str, args: StringResourceArgs, options: pulumi::ResourceOptions) -> StringResource {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "simple-invoke:index:StringResource".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
            version: "10.0.0".to_string(),
...
pub fn get_text(ctx: &pulumi::Context, args: GetTextArgs, options: pulumi::InvokeOptions) -> pulumi::Output<crate::types::GetTextResult> {
    let mut options = options;
    if options.version.is_empty() {
        options.version = "10.0.0".to_string();
    }
...
pub fn secret_invoke(ctx: &pulumi::Context, args: SecretInvokeArgs, options: pulumi::InvokeOptions) -> pulumi::Output<crate::types::SecretInvokeResult> {
    ...
    ctx.invoke("simple-invoke:index:secretInvoke", args.into_inputs(), options).cast()
}
...
pub fn unit(ctx: &pulumi::Context, args: UnitArgs, options: pulumi::InvokeOptions) -> pulumi::Output<crate::types::UnitResult> {
    ...
    ctx.invoke("simple-invoke:index:unit", args.into_inputs(), options).cast()
}
...
pub mod types {
    ...
    impl pulumi::FromPropertyValue for GetTextResult {
