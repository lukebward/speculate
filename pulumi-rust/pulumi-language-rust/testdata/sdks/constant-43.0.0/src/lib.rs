...
pub struct ResourceArgs {
    pub kind: pulumi::Output<std::string::String>,
}
...
impl ResourceArgs {
    pub fn into_inputs(self) -> std::vec::Vec<(std::string::String, pulumi::Output<pulumi::PropertyValue>)> {
        ...
        {
            let v = self.kind;
            inputs.push(("kind".to_string(), v.cast()));
        }
        inputs
    }
...
impl Resource {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ResourceArgs, options: pulumi::ResourceOptions) -> Resource {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "constant:index:Resource".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
    ...
    pub fn kind(&self) -> pulumi::Output<Option<std::string::String>> {
        self.resource.output("kind").cast()
    }
}
...
impl Provider {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ProviderArgs, options: pulumi::ResourceOptions) -> Provider {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "pulumi:providers:constant".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
            version: "43.0.0".to_string(),
