...
pub struct ResourceArgs {
    pub value: pulumi::Output<pulumi::PropertyValue>,
}
...
impl Resource {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ResourceArgs, options: pulumi::ResourceOptions) -> Resource {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "any-handled:index:Resource".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
    ...
    pub fn value(&self) -> pulumi::Output<pulumi::PropertyValue> {
...
impl Provider {
    pub fn new(ctx: &pulumi::Context, name: &str, args: ProviderArgs, options: pulumi::ResourceOptions) -> Provider {
        let resource = ctx.register_resource(pulumi::RegisterRequest {
            type_: "pulumi:providers:any-handled".to_string(),
            name: name.to_string(),
            custom: true,
            remote: false,
            version: "42.0.0".to_string(),
